...
import Controller.ProfilPengelolaController;
...
//        Memblokir jendela lain yang dibuka oleh aplikasi JavaFX        
    ...
    void dashboard(ActionEvent event) throws IOException {
        Pane pane = FXMLLoader.load(OnlyDashBoardPengelolaController.class.getResource("/View/OnlyDashBoardPengelola.fxml"));
        mainPane.setCenter(pane);
        System.out.println("Button lihat toko's Clicked");
    }
    ...
    void profil(ActionEvent event) throws IOException {
        Pane pane = FXMLLoader.load(ProfilPengelolaController.class.getResource("/View/ProfilPengelola.fxml"));
        mainPane.setCenter(pane);
