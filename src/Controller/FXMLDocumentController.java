...
//    Ganti Scene
    ...
    void dashboard(ActionEvent event) throws IOException {
        Pane pane = FXMLLoader.load(OnlyDashboardAdminController.class.getResource("/View/OnlyDashboardAdmin.fxml"));
        mainPane.setCenter(pane);
    ...
    void diagram(ActionEvent event) throws IOException {
        Pane pane = FXMLLoader.load(DiagramController.class.getResource("/View/Diagram.fxml"));
        mainPane.setCenter(pane);
