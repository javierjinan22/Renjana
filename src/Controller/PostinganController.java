...
public class PostinganController implements Initializable {
    ...
    /*Jika ArrayList berjenis Array Class, nanti tidak akan bisa memanggil method, seperti pada line 162 (.... .getJudul())
    ...
    public void initialize(URL url, ResourceBundle rb) {
        //menambah list postingan(di scrollPane) dari dataPostingan ke posts
        ...
        try {
            for (int i = 0; i < posts.size(); i++) {
                ...
                fxmlLoader.setLocation(ItemPostingan.class.getResource("/View/ItemPostingan.fxml"));
