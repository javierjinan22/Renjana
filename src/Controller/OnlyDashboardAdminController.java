...
import Controller.TambahTokoController;
import Controller.TambahWisataController;
import Controller.FXMLDocumentController;
import Controller.TabelPostinganController;
import Controller.TabelTokoController;
import Controller.TabelUserController;
...
public class OnlyDashboardAdminController implements Initializable {
    ...
    void tambahPostingan(ActionEvent event) throws IOException {
        ...
        loader.setLocation(TambahWisataController.class.getResource("/View/TambahWisata.fxml"));
    ...
    void tambahToko(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(TambahTokoController.class.getResource("/View/tambahToko.fxml"));
    ...
    void dataPost(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(TabelPostinganController.class.getResource("/View/TabelPostingan.fxml"));
    ...
    void dataToko(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(TabelTokoController.class.getResource("/View/TabelToko.fxml"));
    ...
    void dataUser(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(TabelUserController.class.getResource("/View/TabelUser.fxml"));
